package com.tospur.common.mail;
/**   
 * 简单邮件（不带附件的邮件）发送器   
 */ 
  ...
  */    
    public boolean sendTextMail(MailBody mailInfo) throws Exception{    
     ...
     // logBefore(logger, "构造一个发送邮件的session");
      ...
      // 创建抄送人的地址    
      if (!StringUtils.isEmpty(mailInfo.getCopyto())) {
         mailMessage.setRecipients(Message.RecipientType.CC, InternetAddress.parse(mailInfo.getCopyto())); 
      } 
      // 设置邮件消息的主题    
	 ...
	 */
	public static boolean sendEmail(String SMTP, String PORT, String EMAIL,
			String PAW, String toEMAIL, String copyTo,String TITLE, String CONTENT,
			String TYPE) {
	...
	/**
	 * 
	 * @param toEmails  收件人  多个以逗号隔开    243634778@qq.com,317664665@qq.com
	 * @param copyEmail  抄送人 多个以逗号隔开   2727492015@qq.com,243634778@qq.com,317664665@qq.com
	 * @param theme  主题
	 * @param content 内容
	 */
    public static boolean sentEmail(String toEmails,String copyEmail,String theme,String content)
    {
        try
        {
            
            
            String email=Global.getConfig("emailName");
            String pwd=Global.getConfig("emailPassword");
            System.out.println(email+"：：：："+pwd);
            MailSendUtils.sendEmail("smtp.126.com",
                    "25", 
                    email, 
                    pwd, 
                    toEmails,
    ...
    {
        sentEmail("1376267587@qq.com","","作业","你在哪里？");
    }
}   
