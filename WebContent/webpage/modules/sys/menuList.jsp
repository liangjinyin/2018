...
<body class="gray-bg">
	...
	<form id="listForm" method="post" style="display: none;">
		<table id="treeTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable table-fixed table-source table-store-cd table-checkbox">
			<colgroup>
				<col style="width:5%">
				<col style="width:16%">
				<col style="width:20%">
			...
			<tbody>
				...
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					<td class="text-center"><input type="checkbox" id="${menu.id}" class="i-checks"></td>
					<td nowrap class="text-center"><i class="icon-${not empty menu.icon?menu.icon:' hide'}"></i><a  href="#" onclick="openDialogView('查看菜单', '${ctx}/sys/menu/form?id=${menu.id}','800px', '500px')">${menu.name}</a></td>
					<td title="${menu.href}" class="text-center">${fns:abbr(menu.href,30)}</td>
					...
					<td title="${menu.permission}" class="text-center">${fns:abbr(menu.permission,30)}</td>
