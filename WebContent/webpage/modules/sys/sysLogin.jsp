  ...
  <%@ page import="org.apache.shiro.web.filter.authc.FormAuthenticationFilter"%>
    <%@ include file="/webpage/include/taglib.jsp"%>
      ...
      <head>
        ...
        <link rel="shortcut icon" href="${ctxStatic}/common/login/images/logo.jpg" type="image/jpeg">
        <!-- text fonts -->
        ...
        <link rel="stylesheet" href="${ctxStatic }/common/login/ace-login.css" />
       <!--  <style type="text/css">
        .light-login{
         background: url(${ctxStatic}/common/login/images/login-img.jpg) no-repeat center;          
        }
        .bound {
          border-radius: 12px;
        }
        ...
        .headLogin {
    			...
    			-webkit-background: rgba(0,0,0,.);
    			-moz-background: rgba(0,0,0,.);
    			-ms-background: rgba(0,0,0,.);
    			-o-background: rgba(0,0,0,.);
    			position: relative;
    			overflow: hidden;
        }
        ...
        .boxInner {
          ...
          -webkit-background: rgba(255,255,255,.);
          -moz-background: rgba(255,255,255,.);
          -ms-background: rgba(255,255,255,.);
          -o-background: rgba(255,255,255,.);
        }
        ...
        #logining:hover span {
          background-color: #7ad8fa !important;
        }
        ...
        .top-logo-box{ height: 50px;}
        .top-logo-box img{ height: 45px; margin-left: 20px;}
        .login-wrapper{
          width:1020px;
          padding: 30px;
          position: absolute;
        ...
        #login-box {
          ...
          -webkit-box-shadow: 0 0 40px rgba(68, 71, 72, .3);
          -moz-box-shadow: 0 0 40px rgba(68, 71, 72, .3);
          -ms-box-shadow: 0 0 40px rgba(68, 71, 72, .3);
          -o-box-shadow: 0 0 40px rgba(68, 71, 72, .3);
        }
        .login-img{float: left;}

        </style>
        <title>运营支撑系统 登录</title>
        <script>
...
<!--         <script type="text/javascript">
      ...
      <body class="login-layout light-login">
        ...
        <div class="login-wrapper">
          <!-- <div class="login-img"><img src="${ctxStatic}/common/login/images/login-img.png" alt=""></div> -->
          <div id="login-box" class="bound">
            <div class="widget-body bound">
                <div class="headLogin">
                 <img src="${ctxStatic}/common/login/images/logo.png" alt="">
                </div>
                <div class="boxInner">
                          ...
                          <c:forEach items="${fns:getDictList('theme')}" var="dict">
                            <li>
                              <a href="#" onclick="location='${pageContext.request.contextPath}/theme/${dict.value}?url='+location.href">
                                <font color="black">${dict.label}</font>
                              </a>
                            </li>
                          </c:forEach>
                        </ul>
