...
<div class="ibox-title">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable table-fixed table-source table-store-cd table-store-rzlb table-checkbox">
		<colgroup>
			<col style="width:3%">
			<col style="width:15%">
			<col style="width:10%">
		...
		<c:forEach items="${page.list}" var="log">
			<tr>
				...
				<td class="viewBig text-center">${log.title}</td>
				...
				<td class="viewBig text-center"><strong>${log.requestUri}</strong></td>
